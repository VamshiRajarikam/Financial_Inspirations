...
<%@ page import java.sql.DriverManager
	import="java.sql.ResultSet,java.sql.SQLException, java.sql.Statement, java.sql.Connection,java.io.IOException, java.io.PrintWriter, java.sql.Connection, java.sql.DriverManager, java.sql.PreparedStatement, java.text.SimpleDateFormat, java.util.Date, javax.servlet.RequestDispatcher, javax.servlet.ServletException, javax.servlet.http.HttpServlet, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse"
			...
			<div class="w3-col m7">
				...
				<div class="w3-container w3-card w3-white w3-round w3-margin">
					...
					<%
						...
						ResultSet resultSet = statement.executeQuery("Select first_name,user_name FROM user");
